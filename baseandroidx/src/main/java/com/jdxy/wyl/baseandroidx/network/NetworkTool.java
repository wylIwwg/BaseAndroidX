...
import com.jdxy.wyl.baseandroidx.network.stetho.NetworkInterceptor;
import com.jdxy.wyl.baseandroidx.network.stetho.NetworkListener;
...
public class NetworkTool {
    ...
    public OkHttpClient.Builder addOkHttp(OkHttpClient.Builder builder, boolean isProxy) {
        ToolLog.e("OkHttpHook" + "-------addOkHttp");
        if (localBuild == null) {
            localBuild = builder
