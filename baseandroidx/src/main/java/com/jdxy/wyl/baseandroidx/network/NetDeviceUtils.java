...
public final class NetDeviceUtils {
    ...
    public static String getWifiName(Context context) {
        ...
        if (wifiManager != null) {
            ...
            ToolLog.e("getWifiName--------", wifiInfo.toString());
            ToolLog.e("getWifiName--------", wifiInfo.getBSSID());
    ...
    public static int getWifiIp(Context context) {
        ...
        if (wifiManager != null) {
            wifiInfo = wifiManager.getConnectionInfo();
            ToolLog.e("getWifiIp--------", wifiInfo.toString());
            ToolLog.e("getWifiIp--------", wifiInfo.getBSSID());
